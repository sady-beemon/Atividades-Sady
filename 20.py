...
while True:
    f = int(input("Digite o salario do funcionario: "))
    ab = f*0.2
    if f == 0:
        break
    elif f > 0:
...
for i in range(len(sal)):
    print("\n",i+1," : Salario = R$ ",sal[i]," abono = R$ ",abo[i])

print("\nNúmero total de funcionário processados: ",cont,
      "\nValor total a ser gasto com o pagamento do abono: ",tabo,
      "\nNúmero de funcionário que receberá o valor mínimo de 100 reais: ",fmin,
      "\nO maior valor pago como abono: ",maxab)